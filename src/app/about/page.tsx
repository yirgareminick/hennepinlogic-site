    ...
    <>
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-primary font-medium mb-4 terminal-text">// about.company</p>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-foreground mb-6">Why Minneapolis focus</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4 text-foreground-muted">
              <p>
                We&apos;re based in Minneapolis. Working with local companies means we can 
                do in-person setup assistance, face-to-face review meetings, and provide 
                support on local time.
              </p>
              <p>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-foreground mb-6">Why plumbing and restoration</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Average emergency plumbing call: $400–$800. Average restoration job: $2,500–$8,000. Missed calls have real revenue impact.",
              },
              {
                title: "24/7 nature",
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-foreground mb-6">How we work</h2>
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                description: "Pilot program is $950. Monthly service is $1,500–$2,500 depending on complexity. No hidden fees or usage-based surprises.",
              },
              {
